<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="GustBook.WEB.Default" %>
...
<body>
    ...
    <div align="center">
        ...
        <table align="center" class="style1">
            <tr>
                <td align="center">
                    <img src="Images/Logo.jpg" alt="" border="0" usemap="#Map" style="width: 800px; height: 239px" /></td>
          </tr>
        </table>
        ...
        <table align="center" class="style1">
			...
			<table cellSpacing="1" cellPadding="5" width="800" bgColor="#cccccc" border="0" align="center">
				<tr>
					<td width="120" rowspan="2" align="center" bgcolor="#ffffff"><strong><img src='<%#Eval("PicUrl") %>' alt="" width="75" height="85" hspace="5" vspace="5" ><br /></strong></td>
					<td bgcolor="#f1f1f1" height="5"><span style="float:right">
					<a href='' target="_blank"><img src="Images/ico_qq.gif" alt='<%# Eval("UserQQ") %>' border="0" /></a>
					<img src="Images/ico_time.gif" alt='<%# Eval("AddTime") %>' />
					<img src="Images/ico_email.gif" alt='<%# Eval("UserEmail") %>' /></span>
					<span style="float:left"><strong><img src='<%#Eval("faceUrl") %>' /> <%# Eval("UserName") %> </span></td>
				  </tr>
				  <tr align="left">
				  <asp:Panel ID="Panel8" runat="server" Visible='<%# Eval("IsHid").ToString()=="0" %>'>
					<td bgcolor="#ffffff" style="table-layout:fixed;word-break:break-all"><%# Eval("Content")%>
					</asp:Panel>
					<asp:Panel ID="Pane9" runat="server" Visible='<%# Eval("IsHid").ToString()=="1"%>'>
					<td bgcolor="#ffffff" style="table-layout:fixed;word-break:break-all"><%#Session["nName"]==null?"[悄悄话]":Eval("Content") %>
					</asp:Panel>
					
					<asp:Panel ID="re" runat="server" Visible='<%# Eval("Reply").ToString()!="" %>'>
					<hr size="1" style="border:1px dotted #333;">
					<span class="text_red">&nbsp;&nbsp;&nbsp[回复]&nbsp;&nbsp;&nbsp<%# Eval("Reply") %></span></asp:Panel>
			...
			<br />
                    ...
                    <webdiyer:AspNetPager ID="AspNetPager1" runat="server" FirstPageText="首页" 
                        LastPageText="未页" NextPageText="下一页" onpagechanged="AspNetPager1_PageChanged" 
                        PrevPageText="上一页" ShowPageIndexBox="Always" PageSize="5">
